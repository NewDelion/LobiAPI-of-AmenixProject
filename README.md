...
## 利用規約
```
ライブラリのソースコードを改変して配布することは許可しますが下記のURLを配布物に含めてください。
本ライブラリを配布又はソフトウェアに付属して配布する場合、ライブラリの使用者又は本ライブラリを利用したソフトウェアの使用者が
下記のURLをいつでも確認できるよう説明書やソフトウェアのUI等に必ず表示してください。
